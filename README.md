...
<div id="hint">Click the Hearts to see a Secret Message</div>
...
const loveNotes = [
    "I like uuu.", "Stay.", "uuu matter.", "Text me.",
    "Always uuu.", "Soft heart.", "Mine?", "Call me?",
    "You glow.", "Don’t overthink.", "Forever.",
    "always uuurs.", "uuu feel safe.", "My person."
];
